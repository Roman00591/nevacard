...
export function Hero() {
  return (
    <section className="relative overflow-hidden pt-24 pb-12 sm:pt-28 sm:pb-16 lg:pt-40 lg:pb-28">
      ...
      <div className="absolute inset-0 -z-10 overflow-hidden pointer-events-none will-change-transform">
        <div className="absolute top-[-20%] right-[-10%] w-[700px] h-[700px] rounded-full bg-primary/[0.04] blur-[100px] transform-gpu" />
        <div className="absolute bottom-[-10%] left-[-5%] w-[500px] h-[500px] rounded-full bg-accent/[0.06] blur-[80px] transform-gpu" />
      </div>
      ...
      <div className="mx-auto max-w-7xl px-5 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="max-w-2xl">
            <div className="inline-flex items-center gap-2.5 rounded-full border border-border bg-card/80 backdrop-blur-sm px-4 py-2 text-sm text-muted-foreground mb-8">
            ...
            <h1 className="font-heading text-3xl font-extrabold tracking-tight text-foreground sm:text-5xl lg:text-[3.5rem] xl:text-6xl text-balance leading-[1.1]">
              Топливные расходы{" "}
          ...
          <div className="relative flex items-center justify-center lg:justify-end">
            <div className="relative w-full max-w-sm sm:max-w-md mx-auto lg:mx-0 px-6 sm:px-0">
              {/* Glow behind card */}
              <div className="absolute inset-4 rounded-3xl bg-primary/10 blur-2xl transform-gpu" />

              {/* Main card */}
              <div className="relative rounded-3xl bg-foreground p-6 sm:p-8 text-primary-foreground shadow-2xl shadow-foreground/20">
              ...
              {/* Floating stats */}
              <div className="absolute -top-4 right-0 sm:-right-4 lg:-right-8 rounded-2xl glass border border-border/60 p-3 sm:p-4 shadow-xl">
              ...
              <div className="absolute -bottom-3 left-0 sm:-left-4 lg:-left-8 rounded-2xl glass border border-border/60 p-3 sm:p-4 shadow-xl">
                <div className="flex items-center gap-2 sm:gap-3">
              ...
              <div className="hidden sm:block absolute top-1/2 -left-2 lg:-left-12 -translate-y-1/2 rounded-2xl glass border border-border/60 p-3 sm:p-4 shadow-xl">
                <div className="flex items-center gap-2 sm:gap-3">
